...
/* v55 Daily Encouragement System */
...
const dailyEncouragementMessages = [
  ...
  "Today is a chance to practice a softer response.",
  "You are more than your anxiety pattern.",
  "One steady habit can change the shape of a day.",
  "You are allowed to protect your energy.",
  "The fact that progress is slow does not mean it is absent.",
  "Let the next step be peaceful, not perfect.",
  "You can be kind to yourself and still grow.",
  "Your calm is worth practicing before the storm arrives.",
  "A moment of pause can prevent a day of regret.",
  "You are learning to lead your mind instead of being led by it.",
  "There is no shame in needing a reset.",
  "Your pace is still a pace.",
  "Today, return to what is real, simple, and within reach.",
  "You do not need to earn rest by exhausting yourself first.",
  "Every steady choice is a quiet victory.",
  "You can step away from a thought without losing control.",
  "The present is often safer than the future your mind imagines.",
  "You are allowed to feel deeply without being ruled by what you feel.",
  "Give yourself credit for continuing.",
  "You can practice peace even before you feel peaceful.",
  "One minute of calm is not small. It is training.",
  "Your life is bigger than this anxious moment.",
  "You do not have to be fearless to be faithful to your goals.",
  "The next right thing does not have to be big.",
  "You can let today unfold without trying to control every outcome.",
  "A calmer mind begins with a gentler relationship with yourself.",
  "You are not late to your own growth.",
  "Let this moment be handled with steadiness.",
  "You can be tired and still worthy.",
  "Your feelings are real, but they are not always final.",
  "Peace is practiced in small returns.",
  "You can stop feeding a thought that is draining you.",
  "Today, choose presence over prediction.",
  "Your mind is allowed to rest.",
  "You are not required to carry every concern at once.",
  "Courage sometimes looks like slowing down.",
  "What you repeat becomes easier. Repeat calm.",
  "You are allowed to take the gentle route.",
  "This moment does not need to become a story about your whole life.",
  "You are capable of steadying yourself.",
  "The day can still become good from here.",
  "You do not have to understand everything to keep moving.",
  "Let your attention return to what supports you.",
  "A peaceful response is still powerful.",
  "You are building emotional strength one pause at a time.",
  "The mind can be noisy while the heart chooses steadiness.",
  "You can honor your feelings without letting them lead every decision.",
  "Today, choose one thing that helps you feel grounded.",
  "You are not weak because your nervous system reacts.",
  "Safety can be practiced.",
  "You do not need to carry the future before it arrives.",
  "There is power in doing one helpful thing.",
  "You can create space between the thought and the reaction.",
  "Small discipline becomes deep freedom.",
  "You are still growing, even on quiet days.",
  "Let peace be the direction, not the demand.",
  "You can meet this day without rushing into fear.",
  "Your progress is not erased by a hard moment.",
  "Today is not all-or-nothing.",
  "You can be learning and healing at the same time.",
  "The path to steadiness is made of returns.",
  "You are allowed to put down what is too heavy.",
  "A calm breath is a decision to come home to yourself.",
  "You do not have to believe the worst-case scenario.",
  "You are more prepared than anxiety wants you to think.",
  "Today, give your mind something kind to practice.",
  "There is strength in choosing not to spiral.",
  "Your peace grows when you stop arguing with uncertainty.",
  "You can take one step without seeing the whole staircase.",
  "Let the present be enough information for now.",
  "You are not your panic. You are the person moving through it.",
  "The body can calm before the mind agrees.",
  "You can be steady without being perfect.",
  "Each reset teaches your mind a new path.",
  "You are allowed to feel safe in small pieces.",
  "Do not underestimate the power of returning to your breath.",
  "Today can be simple and still meaningful.",
  "You can release the need to solve every imagined problem.",
  "Your mind deserves rest from constant forecasting.",
  "Peace is not fragile when it is practiced.",
  "You have survived every anxious day so far.",
  "There is still room for hope today.",
  "Let yourself be supported by small routines.",
  "Your next calm choice matters.",
  "You do not need to punish yourself into progress.",
  "Gentleness can be productive.",
  "You are practicing a new relationship with your thoughts.",
  "A steady path is built by honest effort.",
  "Today, let your nervous system hear: I am safe enough right now.",
  "You can pause before the spiral begins.",
  "The hardest moment is not the whole story.",
  "You do not have to chase every worry.",
  "Your growth is allowed to be gradual.",
  "Calm can start as a practice before it becomes a feeling.",
  "You are worth the effort it takes to care for yourself.",
  "One healthy choice can change the tone of the day.",
  "You can make room for peace without denying pain.",
  "The future will be handled one day at a time.",
  "You do not have to be certain to be steady.",
  "Let today be shaped by intention, not fear.",
  "You can notice anxiety and still choose your values.",
  "A soft answer to yourself can quiet a hard day.",
  "You are not falling behind because you need time.",
  "The next moment is still available.",
  "Your attention can return to what is good.",
  "You can build calm in the middle of ordinary life.",
  "Peace is not a destination. It is a practice.",
  "You do not have to explain your healing pace.",
  "Let the small steady thing be enough today.",
  "You can be present without having everything figured out.",
  "The storm may be loud, but it is not permanent.",
  "You are allowed to be proud of quiet progress.",
  "Every day you practice, you strengthen the path back to calm.",
  "You can step out of urgency and into wisdom.",
  "Your life does not have to be controlled by what ifs.",
  "A single reset can interrupt a pattern.",
  "You are more than the thoughts that scare you.",
  "Let your mind rest from solving problems that are not here yet.",
  "You can choose a calmer response today.",
  "Steadiness is built by repetition.",
  "You are not failing because you need reminders.",
  "Today, do not demand peace. Practice it.",
  "You can hold yourself with patience.",
  "The next breath is enough to begin.",
  "You are learning how to trust yourself again.",
  "Your effort is evidence of hope.",
  "You can take anxiety seriously without letting it make every decision.",
  "Peace becomes easier where it is practiced often.",
  "Do not let fear name your future.",
  "You can be brave in small, quiet ways.",
  "The goal is not to feel nothing. The goal is to respond wisely.",
  "You are allowed to return to calm as many times as needed.",
  "This moment can be met with gentleness.",
  "Your mind can learn new routes.",
  "You do not have to rush through discomfort.",
  "Small progress repeated becomes transformation.",
  "You can let one good choice be enough for now.",
  "Peace is built in the pauses.",
  "You are not alone in learning to steady your mind.",
  "Today, make space for what helps you breathe easier.",
  "You can release the pressure to predict everything.",
  "Your calm is not gone. It may just need practice.",
  "The next step does not have to impress anyone.",
  "You can choose patience when your mind demands panic.",
  "A steady life is made from steady returns.",
  "You are allowed to be human today.",
  "Let your thoughts pass like weather, not commands.",
  "You have the right to protect your peace.",
  "Progress is not always visible from inside the process.",
  "You can slow down before you shut down.",
  "Every calm practice teaches your body a new memory.",
  "You do not need to earn kindness from yourself.",
  "Today, return to what you can control.",
  "You are not behind because healing takes time.",
  "You can move forward without carrying every fear.",
  "The present moment is a safe place to begin again.",
  "You are allowed to stop rehearsing disaster.",
  "Your next breath can be your next beginning.",
  "Do one thing today that makes peace easier tomorrow.",
  "You can be uncertain and still be grounded.",
  "Your progress does not need an audience to be real.",
  "Let your response be calmer than your fear.",
  "You are capable of building a steadier path.",
  "The day is not ruined. It is still unfolding.",
  "You can honor your limits without giving up.",
  "Peace grows when you practice returning.",
  "Your body deserves signals of safety.",
  "You do not have to answer every anxious question.",
  "Small courage is still courage.",
  "You can let calm be quiet and still powerful.",
  "Today, protect your attention like something valuable.",
  "You are stronger than the thought that says you cannot handle this.",
  "You can choose the next helpful step, not the perfect one.",
  "The mind calms through practice, patience, and repetition.",
  "You are allowed to need a slower pace.",
  "Not every hard feeling needs to become a hard day.",
  "You can make peace with the process.",
  "Your steady choices are building something lasting.",
  "You can breathe before you believe the worry.",
  "Let today be guided by care, not pressure.",
  "You are not your anxious prediction.",
  "The calm you practice today becomes easier to find tomorrow.",
  "You can hold fear gently without letting it lead.",
  "Your life is still moving forward.",
  "You are allowed to reset without shame.",
  "The smallest calm action is still a seed.",
  "You can choose truth over anxious imagination.",
  "Today, give your nervous system a reason to trust you.",
  "You do not have to be in control of everything to be okay.",
  "Your future self will thank you for one steady choice today.",
  "Let your breath interrupt the rush.",
  "You are growing in ways you may not see yet.",
  "A peaceful life is built in ordinary moments.",
  "You can keep going without carrying so much.",
  "Your mind can learn to come home.",
  "Today, choose what supports your steadiness.",
  "You are not stuck. You are practicing.",
  "The next small step is not small to your future.",
  "You can release the thought without solving it.",
  "Calm begins when you stop fighting the present moment.",
  "You are allowed to let this day be enough.",
  "Your strength is not measured by how little you feel.",
  "You can meet anxiety with skill instead of fear.",
  "Every return to calm is evidence of growth.",
  "You do not have to finish the journey today.",
  "Let steadiness be your direction.",
  "You can trust yourself to handle the next moment.",
  "Peace is practiced before it is felt.",
  "You are allowed to choose quiet strength.",
  "Today does not need to be perfect to be meaningful.",
  "You are building a life where calm has more room.",
  "The worry may be loud, but it is not the only voice.",
  "You can listen to wisdom instead of urgency.",
  "A steady path begins again every morning.",
  "You are more than what feels difficult today.",
  "Let this be a day of small, honest progress.",
  "You can pause, breathe, and return.",
  "Your calm is worth coming back to.",
  "You do not have to carry all of life at once.",
  "The next gentle choice matters.",
  "You are learning how to stay with yourself.",
  "Peace can be built here, in this ordinary moment.",
...
function loadDailyEncouragement() {
  const messageBox = document.getElementById("dailyEncouragementText");
  if (!messageBox) return;

  const todayKey = new Date().toDateString();
  const savedDate = localStorage.getItem("steadierPath.encouragementDate");
  const savedMessage = localStorage.getItem("steadierPath.encouragementMessage");

  if (savedDate === todayKey && savedMessage) {
    messageBox.textContent = savedMessage;
    return;
  }

  const dayIndex = (getDayOfYear() - 1) % dailyEncouragementMessages.length;
  const todaysMessage = dailyEncouragementMessages[dayIndex];

  localStorage.setItem("steadierPath.encouragementDate", todayKey);
  localStorage.setItem("steadierPath.encouragementMessage", todaysMessage);

  messageBox.textContent = todaysMessage;
}

document.addEventListener("DOMContentLoaded", loadDailyEncouragement);
