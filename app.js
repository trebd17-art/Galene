...
const STEADYMIND_XP_PER_LEVEL=250;
...
const _v31ShowScreen=showScreen;showScreen=function(screenId){_v31ShowScreen(screenId);if(screenId==="rewards")renderRewardsPage();};
const _v31UpdateXP=updateXP;updateXP=function(){
  const i=getSteadyLevelInfo();
...
const _v31SetThoughtDifficulty=typeof setThoughtDifficulty==="function"?setThoughtDifficulty:null;
...
const _v31ResetCalmFocusGame=resetCalmFocusGame;resetCalmFocusGame=function(){_v31ResetCalmFocusGame();const o=document.getElementById("mindWanderOverlay");if(o)o.classList.add("hidden");};
const _v31StartCalmFocusRound=startCalmFocusRound;startCalmFocusRound=function(){const o=document.getElementById("mindWanderOverlay");if(o)o.classList.add("hidden");_v31StartCalmFocusRound();};
...
const _v31OpenAnchorGame=openAnchorGame;openAnchorGame=function(){_v31OpenAnchorGame();setTimeout(setupAnchorTapMovement,150);};
const _v31AnchorMove=anchorMove;anchorMove=function(direction){
...
let thoughtDifficulty = "easy";
let thoughtSortRunning = false;
let thoughtSortIndex = 0;
let thoughtSortScore = 0;
let thoughtSortCombo = 1;
let thoughtSortCurrentBank = [];
let thoughtSortAnswered = false;

const thoughtSortGameBanks = {
  easy: [
