...
v54:
- Restored the Today's Dashboard button to “Start Now →”.
- Button now launches the guided Today’s Reset flow.
- Made the Today's Dashboard button separate from the Home Build/Continue Plan button so it will not be renamed incorrectly.
- No other intentional changes.
- Syntax check: Passed.
